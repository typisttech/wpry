...
- Parser behavior intentionally mirrors WordPress header parsing: only the first 8 KiB are read, CR is normalized to LF, and best-effort encoding fallback is part of the contract.
