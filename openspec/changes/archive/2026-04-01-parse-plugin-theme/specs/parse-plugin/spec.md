...
The parser SHALL return errNoHeader if required headers (at least Plugin Name) are not found in the scanned region. If the input encoding is invalid UTF-8, the parser SHALL return errUnsupportedEncoding.
