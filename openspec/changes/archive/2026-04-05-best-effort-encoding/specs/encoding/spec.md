...
- **WHEN** calling `ParsePlugin` / `ParseTheme` as before
- **THEN** the public signatures SHALL be unchanged and callers SHALL not be able to configure or access decoding logic
